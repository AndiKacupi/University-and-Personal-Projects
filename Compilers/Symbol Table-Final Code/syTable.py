...
def createscopefile():
    ...
    global symbolArray
    global depth
    scopefilepointer = open("scopefile.scp", "w")
    scopefilepointer.write(str(symbolArray) + "\n")
    if (len(symbolArray) != depth):
        symbolArray.pop()
        depth -= 1
    scopefilepointer.close()

def createintfile():
    file_out = open("outx.int", "+w")
    ...
    if (tk == "programtk"):
        ...
        if (tk == "idtk"):
            ...
            if tk == "rightbrackettk":
                ...
                for i in range(0, len(symbolArray[-1])):
                    if (symbolArray[-1][i][0] != "function"):
                        framelen += 4
                if (len(symbolArray) >= 2):
                    symbolArray[-2][-1][-1] = framelen + 4
                    framelen = 12
                createscopefile()
...
def declarations():
    ...
    while (tk == "declaretk"):
        ...
        tk = lex()
        pairinlist.append("variable")
        pairinlist.append(name)
        pairinlist.append(offset)
        offset += 4
        variablesls.append(list(pairinlist))
        del pairinlist[:]
        varList.append(name)
        varlist()

        if (len(symbolArray)):
            symbolArray[-1].extend(list(variablesls))
        else:
            symbolArray.append(list(variablesls))
        del variablesls[:]
        funcoffset = offset
        # offset = 12
...
def subprogram():
    ...
    if (tk == "proceduretk"):
        ...
        if (tk == "idtk"):
            ...
            pairinlist.append("procedure")
            pairinlist.append(name)
            pairinlist.append(funcorprocoffset)
            funcorprocoffset += 4
            variablesls.append(list(pairinlist))
            del pairinlist[:]
            symbolArray.append(list(variablesls))
            ...
            nametemp = name
            functionpos = ['procedure', nametemp]
            funcls.append(functionpos)
...
def statement():
    ...
    if (tk == "idtk"):
        ...
        pairinlist.append(name)
        pairinlist.append(offset)
        lista = list(symbolArray[depth])
        lista.append(list(pairinlist))
        symbolArray[depth] = list(lista)
        del lista[:]
        offset += 4
        del pairinlist[:]
...
def callstat():
    global tk
    global callName
    global listforparameterscheck

    if (tk == "calltk"):
        tk = lex()
        if (tk == "idtk"):

            listforparameterscheck = ['procedure', name]

            callName = name
            tk = lex()
            actualpars()

            listforparameterscheck = listforparameterscheck[:-1]
...
def actualparitem():
    ...
    if (tk == "intk"):
        ...
        listforparameterscheck.append('in')
        ...
        listforparameterscheck.append('inout')
...
def expression():
    ...
    while (tk == "plustk"):
        ...
        pairinlist.append("temporary variable")
        pairinlist.append(w)
        pairinlist.append(offset)
        offset += 4
        lista = list(symbolArray[-1])
        lista.append(list(pairinlist))
        symbolArray[-1] = list(lista)
        del pairinlist[:]
        del lista[:]
